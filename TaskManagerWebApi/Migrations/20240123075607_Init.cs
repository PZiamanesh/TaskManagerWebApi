        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOfStart = table.Column<DateOnly>(type: "date", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskProjects", x => x.ProjectId);
                    table.ForeignKey(
                        name: "FK_TaskProjects_ClientLocations_ClientLocationID",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, 2, new DateOnly(2017, 8, 1), "Hospital Management System", "In Force", 14 },
                    { 2, true, 1, new DateOnly(2018, 3, 16), "Reporting Tool", "Support", 81 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskProjects_ClientLocationID",
                table: "TaskProjects",
